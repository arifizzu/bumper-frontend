...
const RolePermissionEdit = ({ id }) => {
  const navigate = useNavigate();
  const dispatch = useDispatch();
  const form = useSelector((state) => state.role.forms[id]);
  const [selectedPermissions, setSelectedPermissions] = useState([]);

  useEffect(() => {
    const fetchRoleForm = async (id) => {
      try {
        dispatch(editRoleStart());
        const roleData = await editRole(id);
        dispatch(editRoleSuccess({ id, roleData }));
        // console.log("roleData in edit", roleData);
  ...
  const handleFormSubmit = async (values) => {
    ...
    try {
      const result = await updateRole(id, updatedValues);
  ...
  console.log("forms in edit", form);
                ...
                <Row className="mt-2">
                  ...
                  <Col>
                    <Form.Check
                      ...
                      checked={
                        selectedPermissions &&
                        selectedPermissions.includes("view form")
                      }
                    />
                  </Col>
                  <Col>
                    <Form.Check
                      ...
                      checked={
                        selectedPermissions &&
                        selectedPermissions.includes("create form")
                      }
                    />
                  </Col>
                  <Col>
                    <Form.Check
                      ...
                      checked={
                        selectedPermissions &&
                        selectedPermissions.includes("edit form")
                      }
                    />
                  </Col>
                  <Col>
                    <Form.Check
                      ...
                      checked={
                        selectedPermissions &&
                        selectedPermissions.includes("delete form")
                      }
                    />
                  </Col>
                ...
                <Row className="mt-2">
                  <Col>
                    <Form.Check
                      ...
                      checked={
                        selectedPermissions &&
                        selectedPermissions.includes("view process")
                      }
                    />
                  </Col>
                  <Col>
                    <Form.Check
                      ...
                      checked={
                        selectedPermissions &&
                        selectedPermissions.includes("create process")
                      }
                    />
                  </Col>
                  <Col>
                    ...
                    <Form.Check
                      ...
                      checked={
                        selectedPermissions &&
                        selectedPermissions.includes("edit process")
                      }
                    />
                  </Col>
                  <Col>
                    <Form.Check
                      ...
                      checked={
                        selectedPermissions &&
                        selectedPermissions.includes("delete process")
                      }
                    />
                  </Col>
                  <Col className="text-end">
                ...
                <Row className="mt-2">
                  <Col>
                    <Form.Check
                      ...
                      checked={
                        selectedPermissions &&
                        selectedPermissions.includes("view role")
                      }
                    />
                  </Col>
                  <Col>
                    <Form.Check
                      ...
                      checked={
                        selectedPermissions &&
                        selectedPermissions.includes("create role")
                      }
                    />
                  </Col>
                  <Col>
                    <Form.Check
                      ...
                      checked={
                        selectedPermissions &&
                        selectedPermissions.includes("edit role")
                      }
                    />
                  </Col>
                  <Col>
                    <Form.Check
                      ...
                      checked={
                        selectedPermissions &&
                        selectedPermissions.includes("delete role")
                      }
                    />
                  </Col>
                  <Col className="text-end">
                ...
                <Row className="mt-2">
                  <Col>
                    <Form.Check
                      ...
                      checked={
                        selectedPermissions &&
                        selectedPermissions.includes("view permission")
                      }
                    />
                  </Col>
                  <Col>
                    <Form.Check
                      ...
                      checked={
                        selectedPermissions &&
                        selectedPermissions.includes("create permission")
                      }
                    />
                  </Col>
                  <Col>
                    <Form.Check
                      ...
                      checked={
                        selectedPermissions &&
                        selectedPermissions.includes("edit permission")
                      }
                    />
                  </Col>
                  <Col>
                    <Form.Check
                      ...
                      checked={
                        selectedPermissions &&
                        selectedPermissions.includes("delete permission")
                      }
                    />
                  </Col>
                  <Col className="text-end">
                ...
                <Row className="mt-2">
                  <Col>
                    <Form.Check
                      ...
                      checked={
                        selectedPermissions &&
                        selectedPermissions.includes("view user")
                      }
                    />
                  </Col>
                  <Col>
                    <Form.Check
                      ...
                      checked={
                        selectedPermissions &&
                        selectedPermissions.includes("create user")
                      }
                    />
                  </Col>
                  <Col>
                    <Form.Check
                      ...
                      checked={
                        selectedPermissions &&
                        selectedPermissions.includes("edit user")
                      }
                    />
                  </Col>
                  <Col>
                    <Form.Check
                      ...
                      checked={
                        selectedPermissions &&
                        selectedPermissions.includes("delete user")
                      }
                    />
                  </Col>
                  <Col className="text-end">
